...
aging_in_calcs<-function(compartment_pop){
  ...
  lapply(TB_SET, function(t){
    lapply(HIV_SET, function(h){
      lapply(G_SET, function(g){
        N_in_total_temp <<- N_in_total_temp + (mu_t_h_g[t,h,g]*sum(compartment_pop[N_t_r_h_g_ref[t,DR_SET,h,g]]))
    })
  })
})
      ...
      lapply(HIV_SET, function(h){
        lapply(G_SET, function(g){
          ...
          if (r == 1){
            ...
            delta_pop[current_compartment_loc] <<- alpha_in_t_r_h_g[t,r,h,g]*N_in_total + 
              eta_i_h_g_p[other_hiv_ids[1], h, g, policy_id]*compartment_pop[other_hiv_loc1] +
              eta_i_h_g_p[other_hiv_ids[2], h, g, policy_id]*compartment_pop[other_hiv_loc2] + 
              eta_i_h_g_p[other_hiv_ids[3], h, g, policy_id]*compartment_pop[other_hiv_loc3] +
      ...
      lapply(HIV_SET, function(h){
        lapply(G_SET, function(g){
          ...
          if (r == 1){
            ...
            #calculate net gains/losses in compartment
            delta_pop[current_compartment_loc] <<- eta_i_h_g_p[other_hiv_ids[1], h, g, policy_id]*compartment_pop[other_hiv_loc1] +
              eta_i_h_g_p[other_hiv_ids[2], h, g, policy_id]*compartment_pop[other_hiv_loc2] + 
              eta_i_h_g_p[other_hiv_ids[3], h, g, policy_id]*compartment_pop[other_hiv_loc3] +
