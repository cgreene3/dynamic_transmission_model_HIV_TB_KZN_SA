...
mort_df <- read.csv('mort_df_decreaseTB_increaseHIV.csv')
...
png("HIV_prev_overtime_reactivation_chmort1.png")
...
png("ART_coverage_overtime_reactivation_chmort1.png")
