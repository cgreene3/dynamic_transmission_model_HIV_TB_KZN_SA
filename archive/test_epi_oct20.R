...
aging_in_calcs<-function(compartment_pop){
  ...
  mort_mat_temp <- array(data = 0, dim = c(length(TB_SET),
                                              length(DR_SET),
                                              length(HIV_SET),
                                              length(G_SET)))
    ...
    lapply(DR_SET, function(r){
      lapply(HIV_SET, function(h){
        lapply(G_SET, function(g){
          mort_mat_temp[t,r,h,g] <<- sum(parameter_list$mu_t_h_g[t,h,g]*compartment_pop[N_t_r_h_g_ref[t,r,h,g]])
          })
        })
      })
    })
  
  N_in_total_temp <- sum(N_t_r_h_g_init*parameter_list$alpha_out)+sum(mort_mat_temp) 
  total_mort <<- c(total_mort, sum(mort_mat_temp))
  N_in_total_ref <<-c(N_in_total_ref, N_in_total_temp)
  return(N_in_total_temp)
}


######2.2 Force of infection calculations#########
FOI_DS <- function(compartment_pop){
  ...
  lapply(G_SET, function(g){
    lapply(HIV_SET, function(h){
      ...
      pop_temp <- sum(compartment_pop[N_t_r_h_g_ref[6,DR_SET,h,g]])
      
      if (g == 1){
        numerator_MALE[h] <<- parameter_list$phi_h[h] * pop_temp
        
      } else {
        numerator_FEMALE[h] <<- parameter_list$phi_h[h]*pop_temp
      }
...
seir_model <- function(time, compartment_pop, parameters) {
  with(as.list(c(compartment_pop, parameters)), {
    ...
    #aging in
    compartment_pop <- N_t_r_h_g_init
    N_in_total <- aging_in_calcs(compartment_pop)
    
    
    #FOI
    lambda_1_g <- FOI_DS(compartment_pop) #equation 0a
      ...
      lapply(HIV_SET, function(h){
        lapply(G_SET, function(g){
          ...
          delta_pop[N_t_r_h_g_ref[1,r,h,g]] <<- (parameter_list$alpha_in_t_r_h_g[1,r,h,g]*N_in_total) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[1], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[1, r, other_hiv_ids[1], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[2], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[1, r, other_hiv_ids[2], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[3], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[1, r, other_hiv_ids[3], g]]) +
      ...
      lapply(HIV_SET, function(h){
        lapply(G_SET, function(g){
          ...
          if (r == 1){
            ...
            delta_pop[N_t_r_h_g_ref[2,r,h,g]] <<- 
            (parameter_list$eta_i_h_g_p[other_hiv_ids[1], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[2, r, other_hiv_ids[1], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[2], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[2, r, other_hiv_ids[2], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[3], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[2, r, other_hiv_ids[3], g]]) +
              (parameter_list$kappa_t_h_g_p[1,h,g, policy_id]*compartment_pop[N_t_r_h_g_ref[1,r,h,g]]) -
              ((parameter_list$alpha_out +
                 parameter_list$mu_t_h_g[2,h,g] +
                  parameter_list$omega +
      ...
      lapply(HIV_SET, function(h){
        lapply(G_SET, function(g){
          ...
          delta_pop[N_t_r_h_g_ref[3,r,h,g]] <<- parameter_list$alpha_in_t_r_h_g[3,r,h,g]*N_in_total +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[1], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[3, r, other_hiv_ids[1], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[2], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[3, r, other_hiv_ids[2], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[3], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[3, r, other_hiv_ids[3], g]]) +
      ...
      lapply(HIV_SET, function(h){
        lapply(G_SET, function(g){
          ...
          delta_pop[N_t_r_h_g_ref[4,r,h,g]] <<- parameter_list$alpha_in_t_r_h_g[4,r,h,g]*N_in_total +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[1], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[4, r, other_hiv_ids[1], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[2], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[4, r, other_hiv_ids[2], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[3], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[4, r, other_hiv_ids[3], g]]) +
    ...
    lapply(DR_SET, function(r){
      lapply(HIV_SET, function(h){
        lapply(G_SET, function(g){
          ...
          delta_pop[N_t_r_h_g_ref[5,r,h,g]] <<- (parameter_list$eta_i_h_g_p[other_hiv_ids[1], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[1, r, other_hiv_ids[1], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[2], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[1, r, other_hiv_ids[2], g]]) +
            (parameter_list$eta_i_h_g_p[other_hiv_ids[3], h, g, policy_id]*compartment_pop[N_t_r_h_g_ref[1, r, other_hiv_ids[3], g]]) +
...
colnames(out_all_df) <- c('time', compartment_names, 'policy_id')
