    ...
    for (h in HIV_SET){
      for (g in G_SET){
        dN_t_r_h_g[N_t_r_h_g_ref[6,r,h,g]] <- ((alpha_in_t_r_h_g[6,r,h,g]*B) + #entries from births
                                           ...
                                           ((1/varpi_g[g])*theta_h[h]*.01*N_t_r_h_g[N_t_r_h_g_ref[7,r,h,g]]) #testing reactivation 1%
        )
      }
    }
  }
...
png("ART_coverage_overtime_reactivation2.png")
