...
outdir<-"~/Documents/academic_posttt_2020/HIV_TB/calib_outdir/Jun25/n2birthrates"
...
birth_rate_df<-read.csv('birth_rate_df_n2prop.csv')
...
eta_i_h_g[2,3,1]<-(1/7.72)
eta_i_h_g[2,3,2]<-(1/8.5)
...
HIV_transitions_param_func<-function(yr){
  ...
  for (g in G_SET){
    ...
    #eta_i_h_g[2,3,g]<-temp$Reference_expected_value
    eta_i_h_g[2,3,g]<-if_else(g == 1, (1/7.72), (1/8.5))
