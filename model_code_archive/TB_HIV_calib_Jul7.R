...
outdir<-"~/Documents/academic_posttt_2020/HIV_TB/calib_outdir/07_08_2021_reduced_ARTprog_3Point5_changing_births"
...
tb_hiv_prog_calibration_model <- function(time, N_t_r_h_g, parms){
  ...
  #print(current_yr)
  #print(alpha_in_t_r_h_g[1,1,1,1])
  #print(alpha_in_t_r_h_g[1,1,2,1])
...
for(n in 1:nrow(sim_calibration_ref_df)){
  ...
  time_track<-c(time_track, Sys.time()-start)
}
