#Calibration Analysis Dec 07 to 2028
...
indir_state_prog<-paste0("~/Documents/academic_posttt_2020/HIV_TB/calib_outdir/", start_eval_date, 'PLAY_to_2028')

outdir_analysis <- paste0(here(),'/param_files/calibration_code_results/', start_eval_date, 'analysis2/PLAY_1990_2028_ANALYSIS')
...
setwd(paste0(indir_ref_data, '/analysis2'))
...
GBD_calibration_df$HIV_status<-if_else(grepl('neg', GBD_calibration_df$calibration_group), 'neg', 'pos')
