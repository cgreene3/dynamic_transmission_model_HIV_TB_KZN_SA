...
indir_accepted_param_sets<-paste0(here(), '/test/calibration_analysis')
...
tb_hiv_prog_calibration_model <- function(time, N_t_r_h_g, parms){
  ...
  for (g in G_SET){
    FOI_1_g[g]<-((beta_g[g]*(phi_h[1]*N_t_r_h_g[N_t_r_h_g_ref[6, 1, 1, g]])+
...
for(sim_id_current_eval in sim_calibration_ref_df$sim_id){  
